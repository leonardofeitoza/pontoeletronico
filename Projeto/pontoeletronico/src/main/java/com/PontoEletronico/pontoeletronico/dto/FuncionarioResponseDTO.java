...
public class FuncionarioResponseDTO {
    ...
    public FuncionarioResponseDTO(String codFuncionario, String nome, String cpf, String cargo, String setor, String dataAdmissao, Double salario, String descricaoTurno) {
